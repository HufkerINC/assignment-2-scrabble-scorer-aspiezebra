...
//     if (introNum <3 || introNum > 0){
//        console.log(`Using algorithm: ${scoringAlgorithms[introNum].name}
      
//       ${scoringAlgorithms[introNum].description}`)
//       // console.log(word);
//       // console.log(`Is worth ${vowelBonusScore(word)} points`)
//       console.log(`Is worth ${scoringAlgorithms[introNum](word)} points`)
//     }
//     initialPrompt();
//    }
//     if (word == "st0p") {
...
//     //   // console.log(word);
//     //   // console.log(`Is worth ${vowelBonusScore(word)} points`)
//     //   console.log(`Is worth ${scoringAlgorithms[2](word)} points`)
